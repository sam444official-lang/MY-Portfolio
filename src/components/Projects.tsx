...
export const Projects: React.FC = () => {
  ...
  const additionalProjects = data.additionalProjects || [];
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            <h3 className="text-2xl font-bold text-white tracking-tight flex items-center gap-2">
              ...
              <span className="text-xs text-emerald-400 font-mono font-normal">({additionalProjects.length})</span>
            </h3>
          </div>
      ...
      {selectedProjectModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl bg-[#18181B] border border-white/15 p-6 md:p-8 space-y-6 shadow-2xl">
            ...
            {/* Challenges Solved */}
            {selectedProjectModal.challengesSolved && selectedProjectModal.challengesSolved.length > 0 && (
              <div className="space-y-2">
            ...
            {/* Future Improvements */}
            {selectedProjectModal.futureImprovements && selectedProjectModal.futureImprovements.length > 0 && (
              <div className="space-y-2">
